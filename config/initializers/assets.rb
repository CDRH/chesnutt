...
Rails.application.config.assets.paths << Rails.root.join('vendor', 'fancybox-3.5.7')
Rails.application.config.assets.paths << Rails.root.join('vendor', 'datatables-1.11.3')
